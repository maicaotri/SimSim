					...
					<div class="panel-body">
						<form class="form-horizontal" method="" id="ordered"
							...
							<table class="table table-hover table-condensed table-bordered">
								<thead>
									<tr>
										<th class="active text-center col-md-3">Mã hóa đơn</th>
										<th class="active text-center">Sim</th>
										<th class="active text-center">Giá</th>
