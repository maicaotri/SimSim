	...
	<div class="container">
		...
		<div class="cart wow fadeInLeft">
			<a href="${pageContext.request.contextPath}/user/cart"
				...
				class="glyphicon glyphicon-shopping-cart font-12 hidden-xs"></i> Giỏ
				hàng <span class="hidden-xs badge" id="cart">${listCart.size()}</span>
			</a> <a href="${pageContext.request.contextPath}/user/bill"
				class="addcart hidden-xs"> <i
				class="glyphicon glyphicon-shopping-cart font-12 hidden-xs"></i> Đơn
				hàng <span class="hidden-xs badge" id="cart"></span>
			</a>
