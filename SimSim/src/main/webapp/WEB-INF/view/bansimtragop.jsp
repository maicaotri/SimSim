                 ...
                 <style>
                     ...
                     <div class="panel panel-default">
                         <div class="panel-heading">
                             <h1 class="panel-title">Bán sim trả góp</h1>
                         </div>
                         <div class="panel-body">
                             <div class="table-condensed">
                                 <p>
                                     <span style="font-size:18px;">
                                         <strong>Dịch vụ <a href="" target="_blank">bán sim trả góp</a> tại Muasim24h.vn </strong>
                                     </span>
                                     <strong></strong>
                                 </p>
                                 <p>
                                     <strong>Công ty chúng tôi xin thông báo chương trình bán sim trả góp cho tất cả các khách hàng có nhu cầu sử dụng sim số đẹp với phương thức cực kỳ đơn giản và linh hoạt như sau:</strong>
                                 </p>
                                 <p>►
                                     <strong>
                                         <u>Thủ tục mua sim trả góp:</u>
                                     </strong>
                                 </p>
                                 <p> - Quý khách có thể chọn cho mình 1 sim so dep bất kỳ tại hệ thống website : 
                                     <strong>
                                         <strong>Muasim24h.vn</strong>
                                             
                                     </strong>
                                     <strong> </strong>của chúng tôi.</p
                                 ><p>- Quý khách chỉ phải thanh toán trước từ 30% - 50% giá trị của sim và có thể sử dụng sim ngay sau khi ký hợp đồng và thanh toán trước số tiền theo thỏa thuận. <br />
                                     <strong>
                                         <a href="" target="_blank">
                                             <img alt="" class="img-responsive img-responsive img-fluid" height="268" src="" width="670" />
                                         </a>
                                     </strong>
                                 </p>
                                 <p>- Số tiền còn lại quý khách có thể thanh toán hàng tháng hoặc theo chu kỳ tùy theo thỏa thuận 2 bên và thời gian tùy thuộc vào giá trị sim nhưng không quá 18 tháng.</p>
                                 <p>- Quý khách phải trả lãi suất hàng tháng tối thiểu là 3% tính trên số tiền gốc còn thiếu ở mỗi tháng.</p>
                                 <p>- Công ty chúng tôi bảo đảm quyền sở hữu trọn đời cho quý khách với những số sim chúng tôi bán ra</p>
                                 <p>- Hợp đồng mua sim trả góp rõ ràng minh bạch và đảm bảo quyền lợi của 2 bên. ( Hợp đồng làm 2 bản Mỗi bên dữ 1 bản)</p>
                                 <p>
                                     <strong>* Hoàn thành thủ tục trả góp</strong>
                                     <br />- Sau khi quý khách đã thanh toán đủ số tiền cho chúng tôi, chúng tôi sẽ tiến hành<br />
                                     sang tên chính chủ ngay cho quý khách.Hoàn thành thủ tục mua sim trả góp</p>
                                 <p>
                                     <strong>*  Đối với khách hàng tại Hà Nội và Thành Phố Hồ Chí Minh</strong>
                                 </p>
                                 <p>- Nhân viên của chúng tôi sẽ đến tận nơi làm thủ tục 
                                     <a href="">bán sim trả góp</a> cho quý khách.</p>
                                 <p>- Số tiền lãi hàng tháng quý khách có thể chuyển khoản qua ngân hàng, nộp tiền mặt tại công ty hoặc nhân viên chúng tôi sẽ đến tận nơi thu để tránh mất thời gian cho quý khách.</p>
                                 <p> * 
                                     <strong>Đối với khách hàng tại các tỉnh thành khác</strong>
                                 </p>
                                 <p>- Nhân viên của chúng tôi sẽ đến tận nơi làm thủ tục ban sim tra gop cho quý khách ( nếu có chi nhánh của chúng tôi ở khu vực đó) </p>
                                 <p>- Quý khách có thể nhờ người quen tại Hà Nội hoặc T.p Hồ Chí Minh làm thủ tục hộ.</p>
                                 <p>- Trường hợp nếu quý khách không nhờ được người quen, quý khách có thể chuyển tiền qua ngân hàng thanh toán trước 1 phần của sim chọn mua.Chúng tôi sẽ gửi chuyển phát nhanh hợp đồng trả góp và sim về tận nơi cho quý khách.Tiền lãi hàng tháng quý khách sẽ chuyển khoản qua ngân hàng. <br /><br /></p>
                                 <p>
                                     <strong><u>Lưu ý khi mua sim trả góp</u></strong>
                                 </p><p>- Quý khách hãy chọn cho mình 1 
                                     <a href="" target="_blank">sim số đẹp</a> và hợp với mình nhất (quý khách không được trả hoặc đổi lại số khác khi đã ký hợp đồng và đã kích hoạt sim cho quý khách).</p>
                                 <p><strong><u>Cam kết của chúng tôi với quý khách:</u></strong></p>
                                 <p>- Giá bán thấp nhất</p>
                                 <p>- Lãi suất thấp nhất</p>
                                 <p>- Tuyệt đối giữ bí mật thông tin khách hàng</p>
                                 <p>- Thủ tục đơn giản nhanh chóng</p>
                                 <p>- Phục vụ khách hàng tận tình, chu đáo</p>
                                 <p>- Cam kết của chúng tôi luôn luôn 
                                     <a href="">ban sim so dep gia re</a> nhất</p>
                                 <p>
                                     <strong>► Tư vấn</strong>
                                     <strong> mua sim trả góp</strong><br />Mr. Thắng( Quản lý )<br />Mobile: 
                                     <strong>098.459.8888</strong></p><p>
