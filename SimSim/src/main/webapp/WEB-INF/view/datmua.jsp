        ...
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <div class="" id="main">
                    ...
                    <style>#search_box1{display: none !important;</style>
                                 <div class="panel panel-default">
                                     <div class="panel-heading">
                                         <h2 class="panel-title">Đặt mua sim </h2>
                                     </div>
                                     <div class="panel-body">
                                         <form class="form-horizontal" method="" id="ordered" action="" onsubmit="return checkorder()">
                                             <table class="table table-hover table-condensed table-bordered" >
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td>
                                                         <div class="">
                                                             <strong style="size: 16px;">Sim: </strong>
                                                             <strong style="color: red; font-size: 18px;">0868.57.1989</strong>
                                                             <br>
                                                             <strong>Giá: 4,500,000 </strong>VNĐ 
                                                             <br />( bốn  triệu  năm  trăm  nghìn  đồng )<br>
                                                         </div>
                                                         
                                                     </td>
                                                     <td class="text-center">
                                                         <a href="" class="delcart" data-sim="0868571989"> 
                                                 ...
                                                 <tr>
                                                     <td colspan="4" class="active">
                                                         <h5 class="pull-right">Tổng tiền: 
                                                             <span id="total">4,500,000</span> VNĐ
                                                         </h5>
                                                     </td>
                                                 </tr>
                                             </table>
                                             <div class="row">
                                                 <div class="col-md-8">
                                                     <div class="form-group form-group-sm">
                                                         <label class="control-label col-md-4">Họ và tên: 
                                                     ...
                                                     <div class="form-group form-group-sm">
                                                         <label class="control-label col-md-4">Tỉnh/TP: 
                                                             <span class="red">(*)</span>
                                                         </label>
                                                         <div class="col-md-7">
                                                     ...
                                                     <div class="form-group form-group-sm">
                                                         <div class="col-md-12">
                                                             <div class="text-center">
                                                                 <button name="submit" class="btn btn-default ">Đặt mua</button>  
                                                 ...
                                                 <div class="col-md-4 hidden-xs">
                                                     <ul>
                                                         ...
                                                         <li>Hưởng c&aacute;c khuyến m&atilde;i hiện h&agrave;nh của nh&agrave; mạng</li>
                                                         <li>Kh&aacute;ch h&agrave;ng sẽ được đăng k&yacute; ch&iacute;nh chủ khi mua sim</li>
                                                     </ul>
                                                 </div>
                                             </div>
                                     </div>
                                 ...
                                 <div class="panel ">
                                     <div class="panel-body">
                                         <p style="text-align:center">
                                             ...
                                             <p> </p>
                                             <p style="margin-left:45px">Để việc mua sim 
                                                 <strong></strong>
                                                 <strong>0868571989 </strong>
                                                 nhanh chóng và thuận tiện , chúng tôi sẽ gọi điện tư vấn Quý Khách hình thức 
                                                 <strong>Mua Sim</strong>
                                                 nhanh nhất,với thủ tục đơn giản nhất sau khi nhận được thông tin từ Quý Khách<br />
                                                 1. Giao sim trực tiếp tận nơi<br />- Nhân viên 
                                                 <strong>Muasim24h.vn</strong> 
                                                 giao sim tận nhà và đăng ký chính chủ tại Hà Nội Và Thành Phố Hồ Chí Minh và 1 số tỉnh thành có chi nhánh của công ty trên Toàn Quốc<br />2. Chuyển sim qua Bưu Điện,Viettel Post (nhận được sim mới thanh toán tiền, COD)
                                                 <br />Sau khi nhận thông tin 
                                                 <strong>Đặt Mua </strong>
                                                 sim từ Quý Khách, nhân viên 
                                                 <strong>Muasim24h.vn</strong>
                                                 sẽ tiến hành chuyển sim qua bưu điện, thời gian tối đa 48 tiếng sẽ nhận được sim, trường hợp thời gian lâu hơn quý khách vui lòng liên hệ nhân viên kiểm tra lại<br />
                                                 <strong>Lưu ý :</strong> 
                                                 Quy định bưu điện đưa ra là thanh toán tiền sim rồi mới bóc bưu phầm, nên quý khách vui lòng thanh toán trước cho nhân viên bưu điện rồi Call Hotline 24/7 của chúng tôi 0961003003 để kích hoạt sim<br />3. Đăng ký chính chủ sim
                                                 <strong> 0868571989</strong>
                                                 <br />- Quý Khách vui lòng cung cấp 2 mặt chứng minh thư Hoặc thẻ căn cước và 1 ảnh chân dung có thể chụp bằng điện thoại (Theo quy định bộ Thông Tin và Truyền Thông để bảo vệ quyền lợi chính chủ sim)
                                                 <br />- Sau khi nhận đủ thủ tục, giấy tờ nhân viên sẽ đăng ký chính chủ cho quý khách
                                                 <br />Quý Khách Gửi Thông Tin Vào Hotline 24/7: 0961003003 (imessage, viber, zalo, facebook…)
                                                 <br />Chúc Quý Khách Gặp Nhiều May Mắn Khi Sử Dụng Sim 
                                                 <strong>0868571989</strong>
                                                 <br />
                                                 <strong>Lưu ý : Quý Khách Vui Lòng Điền Đầy Đủ Thông Tin vào những ô có dấu (*) Và Ấn Vào Nút “ ĐẶT MUA”</strong>
                                                 <br /><br />Rất hân hạnh được phục vụ quí khách!
                                                 <strong><br />Liên hệ:</strong><br />
                                                 <strong>CÔNG TY TNHH NAM NHẬT THÀNH</strong>
                                                 <br />
                                                 <strong>127B-A5/6 Đinh Tiên Hoàng, P3, Bình Thạnh, Tp.HCM<br />226 Thanh Vỵ, P Sơn Lộc, Tx Sơn Tây, Hà Nội.</strong>
                                                 <br /><strong>Hotline: 0961003003 - 0868551666 - 0868552666 - 0996003003 - 0995003003</strong>
                                                 <strong></strong><br />
                                                 <strong>Fanpage: <a href="" target="_blank">https://www.facebook.com/muasim24h.vn/</a></strong>
                                                 <strong></strong><br />
                                                 <strong>Quản lý: Mr Thắng: 0984598888 - 0996448888</strong>
