		...
		<div class="container">
			...
			<div class="" id="main">
				<div class="panel panel-default hidden-xs" id="search_box">
					...
					<div class="panel-body">
						<form id="search1" action="${pageContext.request.contextPath}/sim/findSim" class="form-horizontal">
							<input name="do" value="search" type="hidden"> <input
								type="hidden" name="submit" value="true" />
							<div class="form-group">
								<div class="col-md-4 col-xs-12 col-lg-4">
							...
							<div class="form-group">
								<div class="input-group">
									<input name="simFinding" id="sim2" type="tel" value=""
										class="form-control pull-left popover-dismiss"
										placeholder="Nhập số sim bạn cần tìm" data-container="body"
										data-toggle="popover" data-placement="bottom"
							...
							<c:forEach items="${list}" var="sim">
								<tr>
									...
									<td class="text-center"><a rel="nofollow"
										title="Thêm sim ${sim.realNumber} vào giỏ hàng" href=""
										class="addcarts" data-sim="${sim.realNumber}" data-gia="4.5"> <i
